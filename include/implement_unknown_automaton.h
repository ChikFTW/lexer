/*
    File:    implement_unknown_automaton.h
    Created: 11 January 2018 at 18:54 Moscow time
...
#ifndef IMPLEMENT_UNKNOWN_AUTOMATON_H
#define IMPLEMENT_UNKNOWN_AUTOMATON_H
