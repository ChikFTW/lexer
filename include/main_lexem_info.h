/*
    ...
    Created: 29 March 2018 at 08:08 Moscow time
...
enum class Main_lexem_code : unsigned short{
    ...
    Equal_sign,           At_sign,              Tuple_begin,
    Tuple_end,            Variant_delimiter,    Conditional_op,
    ...
    Div_assign,           Fdiv_assign,          Mod_assign,
    Lor_assign,           Lor_not_assign,       Lxor_assign,
    Lxor_not_assign,      Land_assign,          Land_not_assign,
    Bor_assign,           Bor_not_assign,       Bxor_assign,
    Bxor_not_assign,      Band_assign,          Band_not_assign,
    Lshift_assign,        Rshift_assign,        Signed_rshift_assign,
    Power_assign,         Fpower_assign,        Pattern_is,
    Br_dots,              Ident
};
